/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇦🇷 Argentina (AR)
 *  ------------------------------------------------------------------
 *  This file is edited by the AR tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = AR,
 *  and lets you override the global result with a AR-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no AR-specific deviation, leave the function unchanged.
 * ================================================================== */
