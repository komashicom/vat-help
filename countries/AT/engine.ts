/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇦🇹 Austria (AT)
 *  ------------------------------------------------------------------
 *  This file is edited by the AT tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = AT,
 *  and lets you override the global result with a AT-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no AT-specific deviation, leave the function unchanged.
 * ================================================================== */
