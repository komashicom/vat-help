/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇦🇺 Australia (AU)
 *  ------------------------------------------------------------------
 *  This file is edited by the AU tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = AU,
 *  and lets you override the global result with a AU-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no AU-specific deviation, leave the function unchanged.
 * ================================================================== */
