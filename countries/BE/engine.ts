/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇧🇪 Belgium (BE)
 *  ------------------------------------------------------------------
 *  This file is edited by the BE tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = BE,
 *  and lets you override the global result with a BE-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no BE-specific deviation, leave the function unchanged.
 * ================================================================== */
