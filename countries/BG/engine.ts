/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇧🇬 Bulgaria (BG)
 *  ------------------------------------------------------------------
 *  This file is edited by the BG tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = BG,
 *  and lets you override the global result with a BG-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no BG-specific deviation, leave the function unchanged.
 * ================================================================== */
