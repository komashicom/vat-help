/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇧🇷 Brazil (BR)
 *  ------------------------------------------------------------------
 *  This file is edited by the BR tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = BR,
 *  and lets you override the global result with a BR-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no BR-specific deviation, leave the function unchanged.
 * ================================================================== */
