/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇨🇳 China (CN)
 *  ------------------------------------------------------------------
 *  This file is edited by the CN tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = CN,
 *  and lets you override the global result with a CN-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no CN-specific deviation, leave the function unchanged.
 * ================================================================== */
