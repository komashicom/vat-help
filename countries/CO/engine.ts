/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇨🇴 Colombia (CO)
 *  ------------------------------------------------------------------
 *  This file is edited by the CO tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = CO,
 *  and lets you override the global result with a CO-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no CO-specific deviation, leave the function unchanged.
 * ================================================================== */
