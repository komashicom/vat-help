/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇨🇿 Czechia (CZ)
 *  ------------------------------------------------------------------
 *  This file is edited by the CZ tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = CZ,
 *  and lets you override the global result with a CZ-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no CZ-specific deviation, leave the function unchanged.
 * ================================================================== */
