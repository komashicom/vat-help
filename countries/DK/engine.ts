/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇩🇰 Denmark (DK)
 *  ------------------------------------------------------------------
 *  This file is edited by the DK tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = DK,
 *  and lets you override the global result with a DK-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no DK-specific deviation, leave the function unchanged.
 * ================================================================== */
