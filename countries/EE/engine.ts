/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇪🇪 Estonia (EE)
 *  ------------------------------------------------------------------
 *  This file is edited by the EE tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = EE,
 *  and lets you override the global result with a EE-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no EE-specific deviation, leave the function unchanged.
 * ================================================================== */
