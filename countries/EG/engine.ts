/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇪🇬 Egypt (EG)
 *  ------------------------------------------------------------------
 *  This file is edited by the EG tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = EG,
 *  and lets you override the global result with a EG-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no EG-specific deviation, leave the function unchanged.
 * ================================================================== */
