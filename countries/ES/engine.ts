/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇪🇸 Spain (ES)
 *  ------------------------------------------------------------------
 *  This file is edited by the ES tax expert (alongside country.json).
 *
 ...
 *  for the scenarios where the SELLER = ES, AFTER the global engine.
 *
...
const BY_RULE: Record<string, string> = {
  "P-B2B-EU-EU": "E5",            // intra-Community supply of goods
  "P-B2B-EU-3": "E2",            // export of goods
  "S-B2B-EU-EU": "N2",            // B2B service, reverse charge in the customer's member state
  "S-B2B-EU-3": "N2",            // B2B service, place of supply outside the EU
  "S-B2C-DIG-EU-3": "N2",            // digital service to a non-EU consumer
};
...
export function customize(
  ...
  const own = countries.find((c) => c.code === "ES");
