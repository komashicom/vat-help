 ...
 *  function here runs ONLY for the scenarios where the SELLER = ES,
 *  and lets you override the global result with a ES-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no ES-specific deviation, leave the function unchanged.
 * ================================================================== */
