/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇫🇮 Finland (FI)
 *  ------------------------------------------------------------------
 *  This file is edited by the FI tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = FI,
 *  and lets you override the global result with a FI-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no FI-specific deviation, leave the function unchanged.
 * ================================================================== */
