/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇫🇷 France (FR)
 *  ------------------------------------------------------------------
 *  This file is edited by the FR tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = FR,
 *  and lets you override the global result with a FR-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no FR-specific deviation, leave the function unchanged.
 * ================================================================== */
