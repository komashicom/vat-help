/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇬🇧 United Kingdom (GB)
 *  ------------------------------------------------------------------
 *  This file is edited by the GB tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = GB,
 *  and lets you override the global result with a GB-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no GB-specific deviation, leave the function unchanged.
 * ================================================================== */
