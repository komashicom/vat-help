/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇬🇪 Georgia (GE)
 *  ------------------------------------------------------------------
 *  This file is edited by the GE tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = GE,
 *  and lets you override the global result with a GE-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no GE-specific deviation, leave the function unchanged.
 * ================================================================== */
