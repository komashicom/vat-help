/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇬🇷 Greece (GR)
 *  ------------------------------------------------------------------
 *  This file is edited by the GR tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = GR,
 *  and lets you override the global result with a GR-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no GR-specific deviation, leave the function unchanged.
 * ================================================================== */
