/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇭🇷 Croatia (HR)
 *  ------------------------------------------------------------------
 *  This file is edited by the HR tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = HR,
 *  and lets you override the global result with a HR-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no HR-specific deviation, leave the function unchanged.
 * ================================================================== */
