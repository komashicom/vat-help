 ...
 *  for the scenarios where the SELLER = HU, AFTER the global engine.
 *
...
const BY_RULE: Record<string, string> = {
  "P-B2B-EU-EU": "KBAET",         // intra-Community supply of goods
  "P-B2B-EU-3": "EAM",           // export of goods
  "S-B2B-EU-EU": "EUFAD37",       // B2B service, reverse charge in the customer's member state
  "S-B2B-EU-3": "HO",            // B2B service, place of supply outside the EU
  "S-B2C-DIG-EU-3": "HO",            // digital service to a non-EU consumer
};
...
export function customize(
  ...
  const own = countries.find((c) => c.code === "HU");
