/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇮🇩 Indonesia (ID)
 *  ------------------------------------------------------------------
 *  This file is edited by the ID tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = ID,
 *  and lets you override the global result with a ID-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no ID-specific deviation, leave the function unchanged.
 * ================================================================== */
