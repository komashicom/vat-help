/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇮🇪 Ireland (IE)
 *  ------------------------------------------------------------------
 *  This file is edited by the IE tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = IE,
 *  and lets you override the global result with a IE-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no IE-specific deviation, leave the function unchanged.
 * ================================================================== */
