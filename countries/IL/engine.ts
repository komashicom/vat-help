/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇮🇱 Israel (IL)
 *  ------------------------------------------------------------------
 *  This file is edited by the IL tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = IL,
 *  and lets you override the global result with a IL-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no IL-specific deviation, leave the function unchanged.
 * ================================================================== */
