/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇮🇳 India (IN)
 *  ------------------------------------------------------------------
 *  This file is edited by the IN tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = IN,
 *  and lets you override the global result with a IN-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no IN-specific deviation, leave the function unchanged.
 * ================================================================== */
