/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇮🇹 Italy (IT)
 *  ------------------------------------------------------------------
 *  This file is edited by the IT tax expert (alongside country.json).
 *
 ...
 *  for the scenarios where the SELLER = IT, AFTER the global engine.
 *
...
const BY_RULE: Record<string, string> = {
  "P-B2B-EU-EU": "N3.2",          // intra-Community supply of goods
  "P-B2B-EU-3": "N3.1",          // export of goods
  "S-B2B-EU-EU": "N2.1",          // B2B service, reverse charge in the customer's member state
  "S-B2B-EU-3": "N2.1",          // B2B service, place of supply outside the EU
  "S-B2C-DIG-EU-3": "N2.1",          // digital service to a non-EU consumer
};
...
export function customize(
  ...
  const own = countries.find((c) => c.code === "IT");
