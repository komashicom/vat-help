 ...
 *  function here runs ONLY for the scenarios where the SELLER = IT,
 *  and lets you override the global result with a IT-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no IT-specific deviation, leave the function unchanged.
 * ================================================================== */
