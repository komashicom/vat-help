/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇯🇵 Japan (JP)
 *  ------------------------------------------------------------------
 *  This file is edited by the JP tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = JP,
 *  and lets you override the global result with a JP-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no JP-specific deviation, leave the function unchanged.
 * ================================================================== */
