/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇰🇷 South Korea (KR)
 *  ------------------------------------------------------------------
 *  This file is edited by the KR tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = KR,
 *  and lets you override the global result with a KR-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no KR-specific deviation, leave the function unchanged.
 * ================================================================== */
