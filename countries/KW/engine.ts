/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇰🇼 Kuwait (KW)
 *  ------------------------------------------------------------------
 *  This file is edited by the KW tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = KW,
 *  and lets you override the global result with a KW-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no KW-specific deviation, leave the function unchanged.
 * ================================================================== */
