/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇱🇹 Lithuania (LT)
 *  ------------------------------------------------------------------
 *  This file is edited by the LT tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = LT,
 *  and lets you override the global result with a LT-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no LT-specific deviation, leave the function unchanged.
 * ================================================================== */
