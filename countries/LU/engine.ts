/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇱🇺 Luxembourg (LU)
 *  ------------------------------------------------------------------
 *  This file is edited by the LU tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = LU,
 *  and lets you override the global result with a LU-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no LU-specific deviation, leave the function unchanged.
 * ================================================================== */
