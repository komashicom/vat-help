/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇱🇻 Latvia (LV)
 *  ------------------------------------------------------------------
 *  This file is edited by the LV tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = LV,
 *  and lets you override the global result with a LV-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no LV-specific deviation, leave the function unchanged.
 * ================================================================== */
