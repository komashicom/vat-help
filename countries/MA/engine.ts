/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇲🇦 Morocco (MA)
 *  ------------------------------------------------------------------
 *  This file is edited by the MA tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = MA,
 *  and lets you override the global result with a MA-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no MA-specific deviation, leave the function unchanged.
 * ================================================================== */
