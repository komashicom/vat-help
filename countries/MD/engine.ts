/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇲🇩 Moldova (MD)
 *  ------------------------------------------------------------------
 *  This file is edited by the MD tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = MD,
 *  and lets you override the global result with a MD-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no MD-specific deviation, leave the function unchanged.
 * ================================================================== */
