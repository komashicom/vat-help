/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇲🇹 Malta (MT)
 *  ------------------------------------------------------------------
 *  This file is edited by the MT tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = MT,
 *  and lets you override the global result with a MT-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no MT-specific deviation, leave the function unchanged.
 * ================================================================== */
