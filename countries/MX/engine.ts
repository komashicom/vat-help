/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇲🇽 Mexico (MX)
 *  ------------------------------------------------------------------
 *  This file is edited by the MX tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = MX,
 *  and lets you override the global result with a MX-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no MX-specific deviation, leave the function unchanged.
 * ================================================================== */
