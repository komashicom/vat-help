/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇳🇬 Nigeria (NG)
 *  ------------------------------------------------------------------
 *  This file is edited by the NG tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = NG,
 *  and lets you override the global result with a NG-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no NG-specific deviation, leave the function unchanged.
 * ================================================================== */
