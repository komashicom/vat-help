/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇳🇱 Netherlands (NL)
 *  ------------------------------------------------------------------
 *  This file is edited by the NL tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = NL,
 *  and lets you override the global result with a NL-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no NL-specific deviation, leave the function unchanged.
 * ================================================================== */
