/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇳🇴 Norway (NO)
 *  ------------------------------------------------------------------
 *  This file is edited by the NO tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = NO,
 *  and lets you override the global result with a NO-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no NO-specific deviation, leave the function unchanged.
 * ================================================================== */
