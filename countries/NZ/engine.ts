/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇳🇿 New Zealand (NZ)
 *  ------------------------------------------------------------------
 *  This file is edited by the NZ tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = NZ,
 *  and lets you override the global result with a NZ-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no NZ-specific deviation, leave the function unchanged.
 * ================================================================== */
