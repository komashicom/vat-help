/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇴🇲 Oman (OM)
 *  ------------------------------------------------------------------
 *  This file is edited by the OM tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = OM,
 *  and lets you override the global result with a OM-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no OM-specific deviation, leave the function unchanged.
 * ================================================================== */
