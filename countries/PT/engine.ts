 ...
 *  for the scenarios where the SELLER = PT, AFTER the global engine.
 *
...
const BY_RULE: Record<string, string> = {
  "P-B2B-EU-EU": "M16",           // intra-Community supply of goods
  "P-B2B-EU-3": "M05",           // export of goods
  "S-B2B-EU-EU": "M40",           // B2B service, reverse charge in the customer's member state
  "S-B2B-EU-3": "M40",           // B2B service, place of supply outside the EU
};
...
export function customize(
  ...
  const own = countries.find((c) => c.code === "PT");
