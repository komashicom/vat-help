/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇶🇦 Qatar (QA)
 *  ------------------------------------------------------------------
 *  This file is edited by the QA tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = QA,
 *  and lets you override the global result with a QA-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no QA-specific deviation, leave the function unchanged.
 * ================================================================== */
