 ...
 *  for the scenarios where the SELLER = SA, AFTER the global engine.
 *
...
const BY_RULE: Record<string, string> = {
  "S-B2B-3-X": "VATEX-SA-33",   // service export by a non-EU seller
};
...
export function customize(
  ...
  const own = countries.find((c) => c.code === "SA");
