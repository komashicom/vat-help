/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇸🇦 Saudi Arabia (SA)
 *  ------------------------------------------------------------------
 *  This file is edited by the SA tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = SA,
 *  and lets you override the global result with a SA-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no SA-specific deviation, leave the function unchanged.
 * ================================================================== */
