/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇸🇪 Sweden (SE)
 *  ------------------------------------------------------------------
 *  This file is edited by the SE tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = SE,
 *  and lets you override the global result with a SE-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no SE-specific deviation, leave the function unchanged.
 * ================================================================== */
