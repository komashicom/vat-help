/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇸🇬 Singapore (SG)
 *  ------------------------------------------------------------------
 *  This file is edited by the SG tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = SG,
 *  and lets you override the global result with a SG-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no SG-specific deviation, leave the function unchanged.
 * ================================================================== */
