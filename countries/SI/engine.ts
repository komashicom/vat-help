/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇸🇮 Slovenia (SI)
 *  ------------------------------------------------------------------
 *  This file is edited by the SI tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = SI,
 *  and lets you override the global result with a SI-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no SI-specific deviation, leave the function unchanged.
 * ================================================================== */
