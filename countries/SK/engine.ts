/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇸🇰 Slovakia (SK)
 *  ------------------------------------------------------------------
 *  This file is edited by the SK tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = SK,
 *  and lets you override the global result with a SK-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no SK-specific deviation, leave the function unchanged.
 * ================================================================== */
