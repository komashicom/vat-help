/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇹🇷 Türkiye (TR)
 *  ------------------------------------------------------------------
 *  This file is edited by the TR tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = TR,
 *  and lets you override the global result with a TR-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no TR-specific deviation, leave the function unchanged.
 * ================================================================== */
