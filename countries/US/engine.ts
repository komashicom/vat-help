/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇺🇸 United States (US)
 *  ------------------------------------------------------------------
 *  This file is edited by the US tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = US,
 *  and lets you override the global result with a US-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no US-specific deviation, leave the function unchanged.
 * ================================================================== */
