/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇻🇳 Vietnam (VN)
 *  ------------------------------------------------------------------
 *  This file is edited by the VN tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = VN,
 *  and lets you override the global result with a VN-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no VN-specific deviation, leave the function unchanged.
 * ================================================================== */
