/* ==================================================================
 *  COUNTRY-SPECIFIC RULES — 🇿🇦 South Africa (ZA)
 *  ------------------------------------------------------------------
 *  This file is edited by the ZA tax expert (alongside country.json).
 *
 ...
 *  function here runs ONLY for the scenarios where the SELLER = ZA,
 *  and lets you override the global result with a ZA-specific
 *  deviation (e.g. a local exemption, a special threshold, a note
 *  pushed into the `notes` array).
 *
 *  If there is no ZA-specific deviation, leave the function unchanged.
 * ================================================================== */
